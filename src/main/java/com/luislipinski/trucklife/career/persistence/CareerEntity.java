...
public class CareerEntity {
    ...
    @Column(name = "driver_name", nullable = false, length = 120) private String driverName;
    @Column(name = "company_name", length = 160) private String companyName;
    @Column(columnDefinition = "text") private String biography;
    @Column(name = "current_level", nullable = false) private short currentLevel;
    ...
    @Column(name = "exchange_rate", nullable = false, precision = 18, scale = 8) private BigDecimal exchangeRate;
    @Column(name = "exchange_rate_as_of") private LocalDate exchangeRateAsOf;
    @Column(name = "state_code", length = 10) private String stateCode;
    @Column(name = "country_code", length = 10) private String countryCode;
    @Column(name = "base_city", nullable = false, length = 160) private String baseCity;
    @Column(name = "default_truck_make", length = 80) private String defaultTruckMake;
    @Column(name = "default_truck_model", length = 120) private String defaultTruckModel;
    @Column(name = "city_market_version", length = 40) private String cityMarketVersion;
    @Column(name = "city_market_label", length = 100) private String cityMarketLabel;
    @Column(name = "city_cost_factor", precision = 8, scale = 4) private BigDecimal cityCostFactor;
    ...
    public CareerEntity(UUID id, UUID userId, CareerGame game, String driverName, String companyName, String biography,
                        short currentLevel, BigDecimal balance, String baseCurrency, String displayCurrency,
                        BigDecimal exchangeRate, LocalDate exchangeRateAsOf, String stateCode, String countryCode,
                        String baseCity, String defaultTruckMake, String defaultTruckModel, String cityMarketVersion,
                        String cityMarketLabel, BigDecimal cityCostFactor, BigDecimal citySalaryFactor,
                        int currentOperationalWeek, Integer currentPayrollMonth, Instant createdAt, Instant updatedAt) {
        this.id=id; this.userId=userId; this.game=game; this.driverName=driverName; this.companyName=companyName;
        this.biography=biography; this.currentLevel=currentLevel; this.balance=balance; this.baseCurrency=baseCurrency;
        this.displayCurrency=displayCurrency; this.exchangeRate=exchangeRate; this.exchangeRateAsOf=exchangeRateAsOf;
        this.stateCode=stateCode; this.countryCode=countryCode; this.baseCity=baseCity; this.defaultTruckMake=defaultTruckMake;
        this.defaultTruckModel=defaultTruckModel; this.cityMarketVersion=cityMarketVersion; this.cityMarketLabel=cityMarketLabel;
    ...
    public BigDecimal getBalance(){return balance;} public String getBaseCurrency(){return baseCurrency;}
    public String getDisplayCurrency(){return displayCurrency;} public BigDecimal getExchangeRate(){return exchangeRate;}
    public LocalDate getExchangeRateAsOf(){return exchangeRateAsOf;} public String getStateCode(){return stateCode;}
    public String getCountryCode(){return countryCode;} public String getBaseCity(){return baseCity;}
    public String getDefaultTruckMake(){return defaultTruckMake;} public String getDefaultTruckModel(){return defaultTruckModel;}
