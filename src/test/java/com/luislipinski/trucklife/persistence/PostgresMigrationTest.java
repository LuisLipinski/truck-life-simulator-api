...
class PostgresMigrationTest {
    ...
    @Test void appliesAllDomainMigrationsThroughFinanceV11(){
        Integer tableCount=jdbcTemplate.queryForObject("""
                ...
                'incidents','incident_payslip_deductions','academy_progress','qualifications','monthly_expenses','monthly_expense_applications','emergency_reserve','emergency_reserve_events')
                """,Integer.class);
        ...
        assertThat(tableCount).isEqualTo(18);assertThat(latest).isEqualTo("11");
    ...
    @Test void exposesTheAppliedFlywayStateWithoutSensitiveDatabaseData(){
        restTestClient.get().uri("/actuator/info").exchange().expectStatus().isOk().expectBody()
                ...
                .jsonPath("$.databaseSchema.currentVersion").isEqualTo("11").jsonPath("$.databaseSchema.pendingMigrations").isEqualTo(0);
    }
